...
const PRODUTOS = [
  ...
  { nome:'Pistola Taurus G3C 9mm', categoria:'armas-de-fogo', sub:'Pistolas', marca:'Taurus',
    calibre:'9x19mm', preco:4290, controlado:true, destaque:true, disponivel:true, imagens:['assets/img/produtos/pistola-taurus-g3c-9mm.jpg'],
  ...
  { nome:'Pistola Taurus G2C .380 ACP', categoria:'armas-de-fogo', sub:'Pistolas', marca:'Taurus',
    calibre:'.380 ACP', preco:3690, controlado:true, destaque:false, disponivel:true, imagens:['assets/img/produtos/pistola-taurus-g2c-380-acp.jpg'], ilustrativa:true,
  ...
  { nome:'Pistola Glock G25 Dark Olive .380 ACP', categoria:'armas-de-fogo', sub:'Pistolas', marca:'Glock',
    ...
    imagens:['assets/img/produtos/pistola-glock-g25-380-acp.jpg',
             'assets/img/produtos/pistola-glock-g25-380-acp-5.jpg',
             'assets/img/produtos/pistola-glock-g25-380-acp-3.jpg',
             'assets/img/produtos/pistola-glock-g25-380-acp-6.jpg',
             'assets/img/produtos/pistola-glock-g25-380-acp-4.jpg',
             'assets/img/produtos/pistola-glock-g25-380-acp-7.jpg'],
  ...
  { nome:'Revólver Taurus RT 838 .38 SPL', categoria:'armas-de-fogo', sub:'Revólveres', marca:'Taurus',
    calibre:'.38 SPL', preco:3450, controlado:true, destaque:false, disponivel:true, imagens:['assets/img/produtos/revolver-taurus-rt-838-38-spl.jpg'],
  ...
  { nome:'Revólver Rossi RM66 .357 MAG', categoria:'armas-de-fogo', sub:'Revólveres', marca:'Rossi',
    calibre:'.357 MAG', preco:3990, controlado:true, destaque:true, disponivel:true, imagens:['assets/img/produtos/revolver-rossi-rm66-357-mag.jpg'],
  ...
  { nome:'Espingarda Boito Pump BSA-84 Niquelada 12 GA', categoria:'armas-de-fogo', sub:'Espingardas', marca:'Boito',
    ...
    imagens:['assets/img/produtos/espingarda-boito-pump-bsa-84-12-ga.jpg'],
  ...
  { nome:'Carabina CBC 8022 .22 LR', categoria:'armas-de-fogo', sub:'Carabinas', marca:'CBC',
    calibre:'.22 LR', preco:2890, controlado:true, destaque:false, disponivel:true, imagens:['assets/img/produtos/carabina-cbc-8022-22-lr.jpg'], ilustrativa:true,
  ...
  { nome:'Munição CBC .38 SPL 158gr CHOG — cx/50', categoria:'municoes', sub:'.38 SPL', marca:'CBC',
    calibre:'.38 SPL', preco:225, controlado:true, destaque:true, disponivel:true, imagens:['assets/img/produtos/municao-cbc-38-spl-158gr-chog-cx-50.jpg'], ilustrativa:true,
  ...
  { nome:'Munição CBC 9x19mm 124gr ETOG — cx/50', categoria:'municoes', sub:'9x19mm', marca:'CBC',
    calibre:'9x19mm', preco:249, controlado:true, destaque:true, disponivel:true, imagens:['assets/img/produtos/municao-cbc-9x19mm-124gr-etog-cx-50.jpg'], ilustrativa:true,
  ...
  { nome:'Munição CBC .380 ACP 95gr — cx/50', categoria:'municoes', sub:'.380 ACP', marca:'CBC',
    calibre:'.380 ACP', preco:215, controlado:true, destaque:false, disponivel:true, imagens:['assets/img/produtos/municao-cbc-380-acp-95gr-cx-50.jpg'], ilustrativa:true,
  ...
  { nome:'Munição CBC .22 LR High Velocity — cx/50', categoria:'municoes', sub:'.22 LR', marca:'CBC',
    calibre:'.22 LR', preco:59, controlado:true, destaque:false, disponivel:true, imagens:['assets/img/produtos/municao-cbc-22-lr-high-velocity-cx-50.jpg'], ilustrativa:true,
  ...
  { nome:'Cartucho CBC 12 GA Chumbo 36g — cx/25', categoria:'municoes', sub:'12 GA', marca:'CBC',
    calibre:'12 GA', preco:189, controlado:true, destaque:false, disponivel:true, imagens:['assets/img/produtos/cartucho-cbc-12-ga-chumbo-36g-cx-25.jpg'], ilustrativa:true,
  ...
  { nome:'Munição CBC .40 S&W 180gr — cx/50', categoria:'municoes', sub:'.40 S&W', marca:'CBC',
    calibre:'.40 S&W', preco:289, controlado:true, destaque:false, disponivel:true, imagens:['assets/img/produtos/municao-cbc-40-s-w-180gr-cx-50.jpg'], ilustrativa:true,
  ...
  { nome:'Carabina de Pressão PCP Rossi Outlander 5.5mm', categoria:'pressao-airsoft', sub:'Carabinas PCP', marca:'Rossi',
    calibre:'5,5mm', preco:3290, controlado:false, destaque:true, disponivel:true, imagens:['assets/img/produtos/carabina-de-pressao-pcp-rossi-outlander-5-5mm.jpg'], ilustrativa:true,
  ...
  { nome:'Pistola de Pressão Gamo P-25 4.5mm', categoria:'pressao-airsoft', sub:'Pistolas de Pressão', marca:'Gamo',
    calibre:'4,5mm', preco:1490, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/pistola-de-pressao-gamo-p-25-4-5mm.jpg'], ilustrativa:true,
  ...
  { nome:'Rifle Airsoft Elétrico M4 CQB 6mm', categoria:'pressao-airsoft', sub:'Airsoft', marca:'Cyma',
    calibre:'6mm', preco:1890, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/rifle-airsoft-eletrico-m4-cqb-6mm.jpg'], ilustrativa:true,
  ...
  { nome:'Coldre Kydex Externo Nível 2', categoria:'tatico', sub:'Coldres', marca:'Invictus',
    preco:389, controlado:false, destaque:true, disponivel:true, imagens:['assets/img/produtos/coldre-kydex-externo-nivel-2.jpg'], ilustrativa:true,
  ...
  { nome:'Colete Tático Modular MOLLE', categoria:'tatico', sub:'Coletes', marca:'Invictus',
    preco:649, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/colete-tatico-modular-molle.jpg'], ilustrativa:true,
  ...
  { nome:'Faca Tática Full Tang com Bainha', categoria:'tatico', sub:'Cutelaria', marca:'Ka-Bar',
    preco:499, controlado:false, destaque:true, disponivel:true, imagens:['assets/img/produtos/faca-tatica-full-tang-com-bainha.jpg'], ilustrativa:true,
  ...
  { nome:'Lanterna Tática 1200 Lumens Recarregável', categoria:'tatico', sub:'Lanternas', marca:'Nitecore',
    preco:329, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/lanterna-tatica-1200-lumens-recarregavel.jpg'], ilustrativa:true,
  ...
  { nome:'Mochila Tática 40L Impermeável', categoria:'tatico', sub:'Mochilas', marca:'Invictus',
    preco:459, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/mochila-tatica-40l-impermeavel.jpg'], ilustrativa:true,
  ...
  { nome:'Prensa de Recarga Progressiva', categoria:'recarga', sub:'Prensas', marca:'Lee',
    preco:4590, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/prensa-de-recarga-progressiva.jpg'], ilustrativa:true,
  ...
  { nome:'Estojo Virgem 9mm — pacote 100un', categoria:'recarga', sub:'Estojos', marca:'CBC',
    preco:189, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/estojo-virgem-9mm-pacote-100un.jpg'], ilustrativa:true,
  ...
  { nome:'Kit Espoletas Small Pistol — 1000un', categoria:'recarga', sub:'Componentes', marca:'CBC',
    preco:0, controlado:true, destaque:false, disponivel:true, imagens:['assets/img/produtos/kit-espoletas-small-pistol-1000un.jpg'], ilustrativa:true,
  ...
  { nome:'Vara Telescópica Marine Sports 1,80m', categoria:'varas', sub:'Telescópicas', marca:'Marine Sports',
    preco:189, controlado:false, destaque:true, disponivel:true, imagens:['assets/img/produtos/vara-telescopica-marine-sports-1-80m.jpg'], ilustrativa:true,
  ...
  { nome:'Vara para Molinete Lumis Infinity 2,10m', categoria:'varas', sub:'Para Molinete', marca:'Lumis',
    preco:329, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/vara-para-molinete-lumis-infinity-2-10m.jpg'], ilustrativa:true,
  ...
  { nome:'Molinete Marine Sports Nautika 4000', categoria:'molinetes', sub:'Molinetes', marca:'Marine Sports',
    preco:349, controlado:false, destaque:true, disponivel:true, imagens:['assets/img/produtos/molinete-marine-sports-nautika-4000.jpg'], ilustrativa:true,
  ...
  { nome:'Molinete Shimano Sienna 2500', categoria:'molinetes', sub:'Molinetes', marca:'Shimano',
    preco:429, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/molinete-shimano-sienna-2500.jpg'], ilustrativa:true,
  ...
  { nome:'Carretilha Perfil Baixo 8 Rolamentos', categoria:'molinetes', sub:'Carretilhas', marca:'Albatroz',
    preco:389, controlado:false, destaque:true, disponivel:true, imagens:['assets/img/produtos/carretilha-perfil-baixo-8-rolamentos.jpg'], ilustrativa:true,
  ...
  { nome:'Isca Artificial Meia-Água 11cm', categoria:'iscas', sub:'Meia-água', marca:'Rapala',
    preco:79, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/isca-artificial-meia-agua-11cm.jpg'], ilustrativa:true,
  ...
  { nome:'Isca de Superfície Zara 9cm', categoria:'iscas', sub:'Superfície', marca:'Marine Sports',
    preco:59, controlado:false, destaque:true, disponivel:true, imagens:['assets/img/produtos/isca-de-superficie-zara-9cm.jpg'], ilustrativa:true,
  ...
  { nome:'Kit 10 Iscas Artificiais Sortidas', categoria:'iscas', sub:'Artificiais', marca:'Sortido',
    preco:189, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/kit-10-iscas-artificiais-sortidas.jpg'], ilustrativa:true,
  ...
  { nome:'Linha Multifilamento 0,30mm 300m', categoria:'linhas', sub:'Linhas', marca:'Fastline',
    preco:129, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/linha-multifilamento-0-30mm-300m.jpg'], ilustrativa:true,
  ...
  { nome:'Cartela Anzóis Sortidos 100un', categoria:'linhas', sub:'Anzóis', marca:'Maruri',
    preco:49, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/cartela-anzois-sortidos-100un.jpg'], ilustrativa:true,
  ...
  { nome:'Kit Chumbadas Oliva 50un', categoria:'linhas', sub:'Chumbadas', marca:'Sortido',
    preco:45, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/kit-chumbadas-oliva-50un.jpg'], ilustrativa:true,
  ...
  { nome:'Puçá Cabo Telescópico 1,80m', categoria:'acessorios-pesca', sub:'Redes e Puçás', marca:'Albatroz',
    preco:159, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/puca-cabo-telescopico-1-80m.jpg'], ilustrativa:true,
  ...
  { nome:'Alicate de Pesca Inox com Corda', categoria:'acessorios-pesca', sub:'Alicates e Ferramentas', marca:'Albatroz',
    preco:119, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/alicate-de-pesca-inox-com-corda.jpg'], ilustrativa:true,
  ...
  { nome:'Caiaque de Pesca 2,90m com Assento', categoria:'acessorios-pesca', sub:'Caixas', marca:'Brudden',
    preco:4290, controlado:false, destaque:true, disponivel:true, imagens:['assets/img/produtos/caiaque-de-pesca-2-90m-com-assento.jpg'], ilustrativa:true,
  ...
  { nome:'Óculos e Abafador de Tiro — Kit Segurança', categoria:'tatico', sub:'Coletes', marca:'TAG',
    preco:289, controlado:false, destaque:false, disponivel:true, imagens:['assets/img/produtos/oculos-e-abafador-de-tiro-kit-seguranca.jpg'], ilustrativa:true,
